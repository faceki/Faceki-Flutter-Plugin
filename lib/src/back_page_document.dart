...
// Navigator.push(context, route)
            Navigator.push( context,MaterialPageRoute(builder: (context)=>     BackPageResult(file: File(image.path),frontFile: widget.frontCard,)));
  } 
  ...
  void onTakePictureButtonPressed() {
    takePicture().then((XFile? file) {
      if (mounted) {
        ...
        if (file != null) {
          Navigator.push(context, MaterialPageRoute(builder: (context)=>BackPageResult(file: File(file!.path), frontFile: widget.frontCard,)));
